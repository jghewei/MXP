...
{
    const oid InletTemp_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 3, 1 };
    ...
    const oid OutletTemp_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 3, 2 };
    ...
    const oid TempLowThd_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 3, 3 };
    ...
    const oid TempHighThd_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 3, 4 };
