...
{
    const oid BoardTemp_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 4, 1 };
    ...
    const oid LowTempThd_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 4, 2 };
    ...
    const oid HighTempThd_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 4, 3 };
    ...
    const oid OperStatus_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 4, 4 };
