...
{
    const oid ServerIpAddress_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 2, 1 };
    ...
    const oid ServerProtocol_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 2, 2 };
    ...
    const oid FilePathName_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 2, 3 };
    ...
    const oid Action_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 2, 4 };
    ...
    const oid State_oid[] = { 1, 3, 6, 1, 4, 1, 19293, 2, 2, 5 };
